    ...
    public class UserService
    {
        ...
        public async Task<User?> GetByIdAsync(int userId)
        {
            ...
            try
            {
                ...
                var userData = await _userRepo.GetByIdAsync(userId);
        ...
        public async Task<User?> GetByUsernameAsync(string username)
        {
            ...
            try
            {
                ...
                var userData = await _userRepo.GetByUsernameAsync(username);
                if (userData == null)
                {
                    _logger.LogError("User not found with username: {Username}", username);
                    throw new KeyNotFoundException("User not found");
                }
                return userData;
            }
