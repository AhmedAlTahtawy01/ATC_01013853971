    ...
    public class UserRepo
    {
        ...
        public async Task<bool> CreateUserAsync(User user)
        {
            ...
            try
            {
                ...
                if (rowsAffected > 1)
                {
                    _logger.LogError("Multiple users created with the same username: {Username}", user.Username);
                    throw new InvalidOperationException("Multiple users created with the same username.");
                }
